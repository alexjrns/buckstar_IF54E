...
public class ProdutoDAO {
	...
	public boolean cadastrar(Produto produto){
		...
		String ultimoFornecedor = String.valueOf(produto.getUltimoFornecedor());
		...
		String[][] vet = { {"id_produto", ""}, {"cod_produto", ""}, {"des_nome", nome}, {"des_marca", marca}, {"dat_ultimacompra", dataUltimaCompra}, {"des_unidadecompra", unidadeCompra},
				...
				{"val_quantidademinima", quantidadeMinima}, {"val_codigobarras", codigoBarras}, {"val_valormediocompra", valorMedioCompra}, {"opt_desativado", desativado}, {"fk_ultimofornecedor", ultimoFornecedor} }; 
